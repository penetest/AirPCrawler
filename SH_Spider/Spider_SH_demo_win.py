...
headers2 = {'Accept':'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8',
           'Accept-Encoding':'gzip, deflate',
           'Accept-Language':'zh-CN,zh;q=0.8',
            'Cookie':'CoreID6=84891504478414626697084&ci=90409626; Hm_lvt_564b417ac8d79d9cf9c2ea3b597e4ec6=1462678702; verynginx_sign_javascript=085e2c343a2a186e088dea0629f9e5e1; verynginx_sign_cookie=e41bcecfa4437af672c47b5877226362; route=35ebcdb0819823db133b8e03099c6a8a; cmTPSet=Y; RadwareP=AYnjFzLICwqMjdRilq+SCQ$$; JSESSIONID=00004lfIbwrpUUmdA2ssUjjqnCv:-1; WT_FPC=id=27a5f9670e2734b349a1462669706483:lv=1463452957702:ss=1463452844026:fs=1462669706483:pv_Num=8:vt_Num=19; 90409626_clogin=l=1463452843&v=1&e=1463454757738',
            'Host':'www.shenzhenair.com',
           'Proxy-Connection':'keep-alive',
           'Upgrade-Insecure-Requests':1,
...
def data_Crawling(from_h,to_h,date_h):
    ...
    try:
        ...
        #第二次请求
        url = 'http://www.shenzhenair.com/uiue/flightSearch.do'
        ...
        #time.sleep(3)
        #第三次请求
        response2 = s.post(url, data=data,headers=headers3,timeout=15)
        #print response2.status_code
        return response2.text,response2.status_code
